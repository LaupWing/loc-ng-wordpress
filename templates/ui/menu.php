<?php
$custom_class = isset($args["custom_class"]) ? $args["custom_class"] : "w-6 h-6";
?>

<svg class="<?php echo $custom_class ?>" stroke="currentColor" fill="none" stroke-width="0" viewBox="0 0 24 24" height="30" width="30" xmlns="http://www.w3.org/2000/svg">
