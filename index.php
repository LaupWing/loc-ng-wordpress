...
<div class="custom-container py-20">
    ...
    <div class="mt-8 flex flex-wrap gap-4 md:!text-lg" data-fade="4">
        <div class="group relative flex">
            ...
            <div class="gradient-animation-border shadow hover:scale-[1.03] active:scale-[0.97] motion-safe:transform-gpu motion-reduce:hover:scale-100 transition duration-100 scale-100 "><button class="rounded font-bold px-4 scale-100 text-gray-600 disabled:bg-gray-200 dark:text-gray-200 dark:disabled:bg-gray-700  bg-white py-[7px]"><a href="/blog">Read the Blog</a></button></div>
